 ...
 * @Date: 2024-03-27 15:43:29
 * @LastEditors: OULIHONG 1756950720@qq.com
 * @LastEditTime: 2024-04-08 17:00:28
 * @FilePath: \蓝牙传感器驱动合集-2024年4月8日\apps\spp_and_le\app_main.c
 * @Description: 
 * 
...
void send_test_timer()
{
    extern void ble_trans_send_data(u8 * packet, u32 size);

    u8 test_data[8] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08};
    ble_trans_send_data(test_data, sizeof(test_data));
    test_data[0]++;
    if (test_data[0] == 0x08)
    {
        test_data[0] = 0x01;
...
void user_main()
{
    task_create(sensor_main, NULL, "sensor_fun");
}
